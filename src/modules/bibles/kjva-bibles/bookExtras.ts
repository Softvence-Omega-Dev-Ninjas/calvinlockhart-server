export const bookExtrass: Record<string, { coverImage: string; author: string }> = {
    GEN: {
    ...
    JUD: {
        coverImage: 'https://i.ibb.co.com/6nLJ0pZ/jud.jpg',
        author: 'Jude',
    },
    REV: {
        coverImage: 'https://i.ibb.co.com/0jq3J0p/rev.jpg',
        author: 'John',
    }
}