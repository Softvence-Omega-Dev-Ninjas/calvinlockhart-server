export default [
  [
    "El libro de Isaías es una extensa profecía en el Antiguo Testamento. El profeta Isaías comunica mensajes de juicio, redención y consuelo a Israel. Predice el nacimiento del Mesías y su reinado justo. A lo largo del libro, se enfatiza la importancia de la fe y la confianza en Dios, así como la promesa de la restauración y la reconciliación con Él.",
  ],
  [
