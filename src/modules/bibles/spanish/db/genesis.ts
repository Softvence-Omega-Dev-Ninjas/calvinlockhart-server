export default [
  [
    "Génesis relata el origen del mundo y de la humanidad. Describe la creación de todo lo que existe, incluyendo el primer hombre y la primera mujer, Adán y Eva. El libro narra eventos clave como el pecado original, el diluvio universal y la construcción de la Torre de Babel. También cuenta la historia de los patriarcas, como Abraham, Isaac y Jacob, y sus descendientes, estableciendo las bases para el pueblo de Israel.",
  ],
  [
