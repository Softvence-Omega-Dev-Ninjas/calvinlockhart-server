export default [
  [
    "El libro de Colosenses es una carta escrita por Pablo a la iglesia en Colosas. En ella, Pablo exalta la supremacía de Cristo como el Creador y el centro de toda la creación. Enseña sobre la redención y reconciliación a través de Cristo, exhorta a los creyentes a vivir en santidad y a buscar las cosas de arriba. Además, enfatiza la importancia de la oración y el amor fraternal en la vida cristiana.",
  ],
  [
