export default [
  [
    "El libro de Jueces describe un ciclo repetitivo en la historia de Israel. Tras la muerte de Josué, Israel cae en el pecado y la idolatría. Dios envía jueces, líderes temporales, para liberar a Israel de la opresión enemiga. Sin embargo, el ciclo se repite cuando Israel vuelve a pecar. El libro destaca la importancia de la obediencia a Dios y los problemas que surgen cuando su pueblo se aparta de él.",
  ],
  [
