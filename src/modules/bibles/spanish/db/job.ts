export default [
  [
    "El libro de Job narra la historia de Job, un hombre justo y piadoso que enfrenta pruebas extremas y sufrimientos. A través de diálogos y discusiones con amigos, Job cuestiona la justicia divina. Finalmente, Dios responde y restaura a Job, mostrando su sabiduría infinita. El libro aborda el sufrimiento humano y la búsqueda de significado, enfatizando la importancia de confiar en la soberanía de Dios.",
  ],
  [
