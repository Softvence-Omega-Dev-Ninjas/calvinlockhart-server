export default [
  [
    "El libro de Nehemías relata la historia de Nehemías, un copero del rey persa, quien lidera la reconstrucción de los muros de Jerusalén después del exilio babilónico. A pesar de la oposición y los desafíos, Nehemías y el pueblo completan la tarea. El libro también destaca la importancia de la reforma religiosa y la renovación del compromiso del pueblo con Dios y su ley.",
  ],
  [
