export default [
  [
    "El libro de Hageo es un breve libro profético en el Antiguo Testamento que anima al pueblo judío a reconstruir el templo de Jerusalén después del exilio babilónico. Hageo reprende al pueblo por priorizar sus propias casas sobre la casa de Dios y promete bendiciones si obedecen. El libro enfatiza la importancia de poner a Dios en primer lugar y termina con la promesa de la restauración y la presencia de Dios en el templo.",
  ],
  [
