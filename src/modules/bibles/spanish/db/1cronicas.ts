export default [
  [
    "El libro de 1 Crónicas es un registro genealógico y una narrativa histórica que abarca desde Adán hasta el reinado del rey David en Israel. Se centra en la genealogía de las tribus de Israel y ofrece detalles sobre el culto en el Templo de Salomón. Este libro destaca la importancia de la adoración a Dios, la obediencia y la lealtad a la casa de David como líder legítimo de Israel.",
  ],
  [
    "Adán, Set, Enós,",
