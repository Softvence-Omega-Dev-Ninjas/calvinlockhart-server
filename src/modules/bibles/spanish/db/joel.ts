export default [
  [
    "El libro de Joel es una profecía que describe una plaga de langostas y una sequía como un llamado al arrepentimiento. Joel predice la efusión del Espíritu Santo en los últimos días y la restauración de Israel. El libro enfatiza el llamado a la adoración, el arrepentimiento y la confianza en Dios en tiempos de adversidad, prometiendo bendiciones y salvación para aquellos que lo buscan sinceramente.",
  ],
  [
