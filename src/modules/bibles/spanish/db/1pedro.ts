export default [
  [
    "El libro de 1 Pedro es una carta dirigida a los creyentes dispersos en diversas regiones. Les anima a perseverar en medio de la persecución y a vivir como extranjeros y peregrinos en este mundo. Destaca la importancia de la santidad, la sumisión a las autoridades y el amor fraternal. También les recuerda que tienen una esperanza viva en Jesucristo y los exhorta a confiar en Dios en medio de las pruebas.",
  ],
  [
