export default [
  [
    "El libro de Josué narra la conquista de Canaán por el pueblo de Israel bajo el liderazgo de Josué, sucesor de Moisés. Después de cruzar el río Jordán milagrosamente, Israel captura Jericó y otras ciudades clave. La tierra se divide entre las tribus de Israel. El libro destaca la fidelidad de Dios en cumplir sus promesas y el llamado a obedecer su ley en la nueva tierra.",
  ],
  [
