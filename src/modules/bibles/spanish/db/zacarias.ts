export default [
  [
    "El libro de Zacarías es una profecía que contiene visiones y mensajes de aliento para el pueblo judío que había regresado del exilio en Babilonia. Predice la restauración de Jerusalén y el templo, así como la venida del Mesías. También destaca la importancia de la justicia y la obediencia. Zacarías es conocido por su visión de los cuatro jinetes y su profecía sobre la venida de un rey humilde montado en un asno, una referencia mesiánica.",
  ],
  [
