export default [
  [
    "El libro de Rut narra la historia de Rut, una mujer moabita que, tras la muerte de su esposo, decide quedarse con su suegra, Noemí, y convertirse al Dios de Israel. Rut trabaja en los campos de Booz y finalmente se casa con él, convirtiéndose en antepasada del rey David. El libro destaca la lealtad, la virtud y la providencia divina en medio de la adversidad.",
  ],
  [
