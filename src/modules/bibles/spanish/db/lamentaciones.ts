export default [
  [
    "El libro de Lamentaciones es una serie de poemas que expresan el lamento y la tristeza por la destrucción de Jerusalén y el exilio del pueblo judío. Está compuesto por cinco capítulos que describen el sufrimiento y la desolación causados por la caída de la ciudad. A pesar de la tristeza, el libro también contiene oraciones de arrepentimiento y súplicas a Dios por restauración y perdón.",
  ],
  [
