export default [
  [
    "La breve carta de Filemón, escrita por el apóstol Pablo, trata sobre el perdón y la reconciliación. Pablo intercede por un esclavo fugitivo llamado Onésimo, instando a su dueño Filemón a recibirlo de vuelta como a un hermano en Cristo. Pablo destaca la transformación de Onésimo y apela a Filemón a perdonar y tratar a su esclavo con amor y gracia.",
  ],
  [
