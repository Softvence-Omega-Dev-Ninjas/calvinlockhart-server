export default [
  [
    "La segunda carta a los Tesalonicenses, escrita por Pablo, aborda las preocupaciones sobre la venida del Señor y la persecución que enfrentaban. Pablo les anima a mantenerse firmes y les da más detalles sobre los eventos que precederán al regreso de Cristo. También advierte sobre la importancia de vivir una vida diligente y ordenada, exhortándolos a trabajar y no depender de los demás.",
  ],
  [
