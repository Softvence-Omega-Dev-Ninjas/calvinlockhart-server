export default [
  [
    "El libro de Jonás relata la historia de un profeta desobediente que es tragado por un gran pez después de intentar huir de la tarea de Dios. En el vientre del pez, Jonás se arrepiente y es liberado. Cumple la misión de advertir a Nínive sobre su inminente destrucción, y la ciudad se arrepiente. El libro destaca la misericordia de Dios y la importancia de la obediencia incluso después de la desobediencia inicial.",
  ],
  [
