export default [
  [
    "El libro de Malaquías es el último libro del Antiguo Testamento. En él, el profeta Malaquías reprende al pueblo de Israel por su falta de devoción y lealtad a Dios. Advierte sobre la venida del mensajero (Juan el Bautista) y el día del Señor. El libro insta a la obediencia y la sinceridad en el servicio a Dios y predice la venida de Elías antes del gran día del juicio.",
  ],
  [
