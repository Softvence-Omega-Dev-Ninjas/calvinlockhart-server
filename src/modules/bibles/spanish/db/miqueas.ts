export default [
  [
    "El libro de Miqueas es una profecía que denuncia la corrupción y la opresión en Israel y Judá. El profeta Miqueas predice el juicio de Dios sobre las naciones por sus pecados, pero también ofrece esperanza en la venida de un futuro Rey en Belén, el Mesías. El libro enfatiza la importancia de la justicia, la humildad y la obediencia a Dios, llamando a la gente a vivir de manera justa y amar la misericordia.",
  ],
  [
