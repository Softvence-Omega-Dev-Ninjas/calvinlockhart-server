export default [
  [
    "El libro de Mateo narra la vida y enseñanzas de Jesús, presentándolo como el Mesías prometido. Destaca los sermones de Jesús, como el Sermón del Monte, y muestra cómo Jesús cumplió las profecías del Antiguo Testamento. Mateo enfatiza la importancia de la fe, la obediencia y el amor al prójimo. También relata la crucifixión y resurrección de Jesús, y concluye con el mandato de difundir el evangelio a todas las naciones.",
  ],
  [
