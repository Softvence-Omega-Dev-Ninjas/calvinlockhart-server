export default [
  [
    "El libro de 2 Samuel sigue la historia del rey David en Israel. Describe su reinado, victorias militares y la instauración de Jerusalén como la capital. También narra los desafíos morales y personales que enfrenta David, incluido su pecado con Betsabé. A pesar de sus errores, Dios renueva su pacto con David. El libro resalta la importancia de un liderazgo justo y la fidelidad a Dios.",
  ],
  [
