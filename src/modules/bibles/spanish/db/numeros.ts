export default [
  [
    "El libro de Números narra la historia del pueblo de Israel en el desierto después de su liberación de Egipto. Detalla el censo de los israelitas, las leyes y regulaciones dadas por Dios, los viajes y acampamentos en el desierto, y las pruebas y desobediencia del pueblo. A pesar de los desafíos, Dios guía y provee para su pueblo, preparándolos para ingresar a la tierra prometida.",
  ],
  [
