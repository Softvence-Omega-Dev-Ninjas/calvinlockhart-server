export default [
  [
    "El libro de Sofonías es un libro profético que advierte sobre el juicio inminente de Dios sobre Judá debido a su idolatría y maldad. Sofonías llama al arrepentimiento y la humildad, pero también ofrece esperanza, prometiendo un remanente redimido y restaurado. El libro culmina en una visión de alegría y restauración futura para el pueblo de Dios después del juicio.",
  ],
  [
