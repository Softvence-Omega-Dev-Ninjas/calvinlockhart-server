export default [
  [
    "El libro de Nahúm es una profecía corta que anuncia la caída de Nínive, la capital asiria. Describe la destrucción inminente de la ciudad debido a su maldad y crueldad. Nahúm enfatiza la justicia de Dios y su poder para castigar a las naciones impías. Aunque es un mensaje de juicio, ofrece consuelo a las naciones oprimidas, mostrando que Dios cuida de su pueblo y trae justicia.",
  ],
  [
