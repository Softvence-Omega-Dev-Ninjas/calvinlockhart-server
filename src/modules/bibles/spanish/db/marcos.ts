export default [
  [
    "El libro de Marcos relata la vida y ministerio de Jesús de manera concisa y dinámica. Destaca los milagros y enseñanzas de Jesús, su autoridad sobre los demonios y su pasión por servir a los demás. Marcos enfatiza la importancia de la fe y el discipulado, mostrando a Jesús como el Siervo sufriente que vino a dar su vida como rescate por muchos. Termina con la resurrección de Jesús y la comisión de predicar el evangelio.",
  ],
  [
