export default [
  [
    "El libro de Lucas presenta un relato detallado de la vida y ministerio de Jesús, resaltando su compasión por los necesitados y marginados. Lucas enfatiza la enseñanza del amor, la gracia y la salvación para todos. Además, registra parábolas y milagros únicos, y narra el nacimiento, la crucifixión y la resurrección de Jesús. Su propósito es ofrecer un relato completo y confiable de la vida de Cristo.",
  ],
  [
