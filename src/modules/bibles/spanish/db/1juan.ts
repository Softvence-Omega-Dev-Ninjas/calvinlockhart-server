export default [
  [
    "El libro de 1 Juan es una carta escrita por el apóstol Juan con el propósito de fortalecer la fe de los creyentes y recordarles la importancia del amor y la obediencia a Dios. Destaca la importancia de creer en Jesucristo como el Hijo de Dios, vivir en amor y evitar el pecado. También aborda temas como la confianza en Dios, la comunión con otros creyentes y la victoria sobre el mundo.",
  ],
  [
