export default [
  [
    "El libro de Hechos narra la expansión del cristianismo desde Jerusalén hasta Roma. Describe los primeros días de la Iglesia, el ministerio de los apóstoles, el derramamiento del Espíritu Santo y la predicación del evangelio. También relata las persecuciones, los milagros y la conversión de Pablo. Hechos muestra cómo el Espíritu Santo capacitó a los creyentes para difundir el mensaje de Jesús y establecer comunidades de fe en todo el mundo antiguo.",
  ],
  [
