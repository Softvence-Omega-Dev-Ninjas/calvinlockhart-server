export default [
  [
    "El libro de Salmos es una colección poética y lírica que expresa los sentimientos, emociones y experiencias del pueblo de Israel en relación con Dios. Contiene alabanzas, oraciones, lamentos y reflexiones sobre la grandeza de Dios y su fidelidad. Los Salmos transmiten un mensaje de confianza en Dios, adoración, arrepentimiento y búsqueda de guía divina. Son una fuente de consuelo y fortaleza espiritual para el creyente.",
  ],
  [
  ...
  [
    ...
    "Porque ha engrandecido sobre nosotros su misericordia, Y la fidelidadde Jehová es para siempre. Aleluya.",
  ],
  [
    "Alabad a Jehová, porque él es bueno; Porque para siempre es su misericordia.",
