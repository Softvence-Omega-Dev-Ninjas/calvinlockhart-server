export default [
  [
    "El libro de Ezequiel es una profecía que relata las visiones y el ministerio del profeta Ezequiel durante el exilio babilónico. Contiene imágenes simbólicas y profecías de juicio, pero también de restauración y esperanza para Israel. Ezequiel destaca la necesidad de la fidelidad a Dios y anuncia la venida de un nuevo templo y una renovación espiritual. El libro subraya la soberanía y la gloria de Dios en medio de la adversidad.",
  ],
  [
