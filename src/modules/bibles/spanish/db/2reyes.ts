export default [
  [
    "El libro de 2 Reyes continúa la historia de Israel y Judá, relatando los reinados de varios reyes y profetas. Destaca la desobediencia del pueblo a Dios y los juicios divinos que resultan en la destrucción de Jerusalén y el exilio. El profeta Eliseo desempeña un papel importante, realizando milagros. El libro subraya la importancia de la fidelidad a Dios y muestra las consecuencias de la apostasía.",
  ],
  [
