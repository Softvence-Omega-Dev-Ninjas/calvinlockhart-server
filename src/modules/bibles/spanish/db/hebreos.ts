export default [
  [
    "El libro de Hebreos es una carta que enfatiza la superioridad de Jesucristo como sumo sacerdote y mediador de un nuevo pacto. Presenta a Jesús como el cumplimiento de las promesas del Antiguo Testamento y exhorta a los creyentes a perseverar en la fe. Destaca la superioridad de Cristo sobre los ángeles, Moisés y el sacerdocio levítico, y anima a los creyentes a confiar en Él en medio de la adversidad.",
  ],
  [
