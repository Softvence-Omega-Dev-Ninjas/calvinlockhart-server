export default [
  [
    "La carta a Tito, escrita por el apóstol Pablo, se centra en la importancia del liderazgo y la organización en la iglesia. Pablo instruye a Tito sobre la selección de líderes piadosos y la enseñanza de una sana doctrina. También destaca la importancia de vivir vidas transformadas por la gracia de Dios y exhorta a los creyentes a ser ejemplos de buen comportamiento en la sociedad.",
  ],
  [
