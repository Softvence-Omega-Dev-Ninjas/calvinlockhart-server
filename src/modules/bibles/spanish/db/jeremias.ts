export default [
  [
    "El libro de Jeremías es un extenso libro profético que relata el ministerio del profeta Jeremías en el antiguo Israel. Jeremías advierte al pueblo sobre su idolatría y su falta de fidelidad a Dios, pronosticando la inminente destrucción de Jerusalén y el exilio. A pesar del juicio, el libro también ofrece la promesa de un nuevo pacto y restauración en el futuro, destacando la misericordia y el amor de Dios hacia su pueblo.",
  ],
  [
