export default [
  [
    "El libro de 1 Reyes relata la historia de los reyes de Israel y Judá, desde el reinado del rey Salomón hasta el reinado de Acab y Elías el profeta. Destaca la construcción del Templo de Salomón y las divisiones en el reino después de su muerte. El libro también enfatiza la importancia de la obediencia a Dios y presenta la confrontación entre Elías y los profetas de Baal.",
  ],
  [
