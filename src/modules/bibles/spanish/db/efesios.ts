export default [
  [
    "El libro de Efesios es una carta de Pablo dirigida a la iglesia en Efeso. En ella, Pablo destaca la grandeza de la salvación en Cristo y la unidad del cuerpo de creyentes. Habla sobre la vida en Cristo, exhorta a vivir en amor y sabiduría, y exhorta a los creyentes a ponerse la armadura de Dios para luchar contra las fuerzas espirituales. También enfatiza el papel de los creyentes como testigos de Cristo en el mundo.",
  ],
  [
