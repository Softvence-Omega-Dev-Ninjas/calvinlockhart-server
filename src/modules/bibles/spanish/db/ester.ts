export default [
  [
    "El libro de Ester es una narración de la historia de Ester, una joven judía que se convierte en reina de Persia. Con la ayuda de su primo Mardoqueo, Ester interviene para salvar a su pueblo de un complot para destruirlos. La historia destaca la providencia divina y la valentía de Ester. El libro de Ester no menciona directamente a Dios, pero muestra cómo su providencia opera en la historia humana.",
  ],
  [
