export default [
  [
    "El libro de Romanos explica la doctrina de la salvación y la justificación por fe. El apóstol Pablo presenta una profunda reflexión teológica sobre el pecado, la ley, la gracia y la obra redentora de Jesucristo. Destaca que todos somos pecadores y que solo a través de la fe en Jesús podemos obtener la justificación y la vida eterna. Romanos es una carta fundamental para entender la teología cristiana y el plan de salvación de Dios.",
  ],
  [
