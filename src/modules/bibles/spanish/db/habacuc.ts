export default [
  [
    "El libro de Habacuc es un libro profético que registra las quejas del profeta sobre la iniquidad y la opresión en Judá. Dios responde que traerá juicio a través de la conquista babilónica. Habacuc lucha con la justicia divina, pero finalmente acepta la soberanía de Dios y encuentra esperanza en medio de la adversidad, confiando en que Dios es su fortaleza y salvación.",
  ],
  [
