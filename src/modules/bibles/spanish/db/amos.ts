export default [
  [
    "El libro de Amós es una profecía que denuncia la injusticia social y religiosa en Israel. Amós, un pastor y horticultor, predice el juicio de Dios debido a la opresión de los pobres y la corrupción. Aunque es un mensaje de condena, el libro también ofrece la promesa de restauración y renuevo. Amós enfatiza la importancia de la justicia, la equidad y la búsqueda de Dios en lugar de la religión vacía.",
  ],
  [
