export default [
  [
    "El libro de Abdías es el libro más corto del Antiguo Testamento y contiene una profecía dirigida principalmente contra Edom, un vecino de Israel. Abdías denuncia la arrogancia de Edom y predice su ruina debido a su orgullo y su papel en la destrucción de Jerusalén. El libro también subraya la justicia de Dios y la restauración de Israel. En resumen, Abdías advierte sobre la arrogancia y el juicio divino contra las naciones soberbias.",
  ],
  [
