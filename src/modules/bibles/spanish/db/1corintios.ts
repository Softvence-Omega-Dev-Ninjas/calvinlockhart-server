export default [
  [
    "El libro de 1 Corintios aborda los problemas y desafíos que enfrentaba la iglesia de Corinto. El apóstol Pablo les enseña sobre la unidad, la santidad, la sabiduría divina y el amor. También aborda temas como los dones espirituales, la resurrección y la importancia de vivir de acuerdo con los principios cristianos. 1 Corintios nos anima a vivir en armonía, amor y compromiso con Dios y los demás.",
  ],
  [
