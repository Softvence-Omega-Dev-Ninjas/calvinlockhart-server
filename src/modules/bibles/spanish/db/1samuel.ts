export default [
  [
    "El libro de 1 Samuel narra el período de transición en Israel desde los jueces hasta la monarquía. Comienza con el nacimiento y llamado del profeta Samuel, quien ungió a Saúl como el primer rey de Israel. Más tarde, David es ungido como el futuro rey. El libro aborda las luchas políticas y espirituales de la época, destacando la importancia de la obediencia y la relación con Dios.",
  ],
  [
