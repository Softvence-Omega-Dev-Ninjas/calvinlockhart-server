export default [
  [
    "El libro de 2 Pedro es una carta en la que el apóstol Pedro advierte a los creyentes sobre los falsos maestros y exhorta a la perseverancia en la fe. Destaca la importancia del conocimiento de Dios y su Palabra, la necesidad de vivir vidas santas y el juicio venidero. Anima a los creyentes a crecer en la gracia y el conocimiento de Jesucristo, y a mantenerse firmes en la verdad.",
  ],
  [
