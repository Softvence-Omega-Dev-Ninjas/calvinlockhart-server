export default [
  [
    "El libro de Filipenses es una carta escrita por Pablo a la iglesia en Filipos. En ella, Pablo expresa su amor y gratitud hacia los filipenses y les anima a vivir en alegría y unidad. Destaca la humildad de Cristo como ejemplo a seguir y enfatiza la importancia de la fe en Cristo y la confianza en su poder transformador. También les insta a mantenerse firmes en la fe y a buscar la paz y la unidad entre los creyentes.",
  ],
  [
