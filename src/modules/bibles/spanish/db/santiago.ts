export default [
  [
    "El libro de Santiago es una carta práctica que insta a los creyentes a vivir una fe genuina y activa. Enfatiza la importancia de la obediencia a la Palabra de Dios, la perseverancia en las pruebas y la práctica de una fe que se refleje en buenas obras. También aborda temas como el control de la lengua, la humildad y la oración. Es un llamado a vivir una vida cristiana auténtica y transformada.",
  ],
  [
