export default [
  [
    "El libro de Proverbios es una recopilación de sabiduría y consejos prácticos para vivir una vida recta y sabia. Está compuesto por breves enseñanzas y refranes que abordan temas como la sabiduría, la prudencia, la justicia, la rectitud y la conducta moral. Los proverbios ofrecen instrucciones para tomar decisiones sabias, evitar los caminos de la maldad y buscar la voluntad de Dios en todas las áreas de la vida.",
  ],
  [
