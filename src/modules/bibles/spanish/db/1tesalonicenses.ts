export default [
  [
    "La primera carta a los Tesalonicenses, escrita por Pablo, anima y exhorta a los creyentes a mantenerse firmes en la fe y a vivir una vida santa en anticipación del regreso de Cristo. Pablo les anima en su amor mutuo y les da instrucciones sobre diversos asuntos prácticos. También les consuela en relación a los creyentes fallecidos, asegurándoles que tendrán parte en la resurrección final.",
  ],
  [
