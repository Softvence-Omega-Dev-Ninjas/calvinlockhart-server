export default [
  [
    "La segunda carta a Timoteo, escrita por el apóstol Pablo, es un llamado a la fidelidad y perseverancia en el ministerio. Pablo anima a Timoteo a mantenerse firme en la fe, recordándole la importancia de la Palabra de Dios, la enseñanza sólida y el ejemplo de fe. También advierte sobre los desafíos y la persecución que enfrentará, y le insta a perseverar en el servicio a Dios hasta el final.",
  ],
  [
