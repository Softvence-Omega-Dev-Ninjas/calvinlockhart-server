export default [
  [
    "El libro de Apocalipsis, escrito por el apóstol Juan, revela visiones proféticas y simbólicas sobre el fin de los tiempos y el retorno de Jesucristo. Presenta la batalla final entre el bien y el mal, la destrucción de Babilonia y la victoria final de Dios. También describe la nueva Jerusalén, el juicio final y la renovación de todas las cosas. Apocalipsis nos anima a perseverar en la fe y esperar con esperanza el cumplimiento de las promesas de Dios.",
  ],
  [
