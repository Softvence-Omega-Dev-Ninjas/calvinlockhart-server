export default [
  [
    "El libro de 2 Corintios es una carta de Pablo a la iglesia en Corinto. En esta carta, Pablo les expresa su amor y preocupación, y les anima a perseverar en la fe a pesar de los desafíos. Les habla sobre el consuelo de Dios en medio de las dificultades y enfatiza la importancia de vivir una vida transformada por el amor de Cristo. También aborda temas como la generosidad, la reconciliación y la autoridad apostólica.",
  ],
  [
