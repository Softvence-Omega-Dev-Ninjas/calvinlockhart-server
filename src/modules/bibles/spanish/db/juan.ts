export default [
  [
    "El libro de Juan presenta una perspectiva única del ministerio de Jesús, enfocándose en su divinidad y su relación con el Padre. Juan resalta los milagros, los discursos y las interacciones de Jesús, mostrando cómo revela el amor de Dios y ofrece salvación a través de la fe en Él. También destaca el Espíritu Santo y la importancia de creer en Jesús como el Hijo de Dios para obtener vida eterna.",
  ],
  [
