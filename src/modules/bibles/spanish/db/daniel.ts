export default [
  [
    "El libro de Daniel narra la historia de Daniel, un joven judío llevado cautivo a Babilonia. Daniel y sus amigos enfrentan desafíos y pruebas mientras mantienen su fe en Dios. El libro contiene profecías apocalípticas y eventos notables, como la interpretación de sueños del rey Nabucodonosor y la experiencia de Daniel en el foso de los leones. En última instancia, Daniel destaca la soberanía de Dios y la recompensa de la fidelidad.",
  ],
  [
