export default [
  [
    "El libro de Esdras registra el retorno de los judíos del exilio babilónico a Jerusalén. Esdras, un escriba y sacerdote, lidera la restauración de la ley y el culto en el templo. El libro enfatiza la importancia de la obediencia a la ley de Dios y la separación de matrimonios mixtos. También describe la reconstrucción del templo y las luchas que enfrenta la comunidad al regresar a su tierra.",
  ],
  [
