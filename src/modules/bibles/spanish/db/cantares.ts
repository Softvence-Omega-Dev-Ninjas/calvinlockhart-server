export default [
  [
    "El libro de Cantares, también conocido como Cantar de los Cantares o Cantar de Salomón, es un poema lírico que celebra el amor y la pasión entre un esposo y su amada. Es una representación poética del amor humano, pero también se interpreta como una alegoría del amor divino entre Dios y su pueblo. Es una expresión artística y emotiva que destaca la belleza del amor romántico y la unión entre dos personas.",
  ],
  [
