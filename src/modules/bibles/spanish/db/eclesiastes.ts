export default [
  [
    'El libro de Eclesiastés, atribuido al rey Salomón, reflexiona sobre la vanidad de la vida y la búsqueda del sentido. "Vanidad de vanidades, todo es vanidad", es su famoso verso. El autor expone la temporalidad y las incertidumbres de la existencia humana. Al final, concluye que temer a Dios y guardar sus mandamientos es el propósito más significativo en esta vida.',
  ],
  [
