export default [
  [
    "El libro de 3 Juan es una breve carta escrita por el apóstol Juan a un hombre llamado Gayo. Juan elogia la fidelidad y hospitalidad de Gayo hacia los hermanos en la fe y advierte contra la influencia negativa de un hombre llamado Diótrefes, quien rechaza la autoridad apostólica. Juan exhorta a Gayo a seguir haciendo el bien y a no imitar el mal ejemplo de Diótrefes.",
  ],
  [
